<?php
    ...
    if(isset($_POST['save'])) {
     ...
     if(!in_array($extension,['zip', 'pdf', 'rar', 'png', 'jpg', 'jpeg', 'docx', 'doc', 'txt'])) {
             echo "Tu extension de archivo deben ser .zip, .pdf, .rar, .png, .jpg, .doc, .docx, .txt";
